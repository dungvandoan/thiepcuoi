...
const entryUrl =
  process.env.ENTRY_URL ||
  process.argv[2] ||
  "https://cinelove.me/template/pc/thiep-cuoi-2";
...
run().catch((e) => {
  process.stderr.write(String(e?.stack || e || "Unknown error") + "\n");
  process.exitCode = 1;
});
